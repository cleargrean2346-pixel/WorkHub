...
export default async function PendingPage() {
  ...
  return <main className="onboarding"><section className="onboarding-card"><Link className="brand" href="/"><span className="brand-mark">W</span><span>workhub</span></Link><p className="eyebrow"><span /> 승인 대기</p><h1>승인 대기 중입니다</h1><p>관리자가 계정을 확인하면 워크스페이스 접근이 승인됩니다. 승인 후 다시 로그인하면 바로 홈 화면으로 이동합니다.</p><Link className="back-link" href="/login">로그인 화면으로</Link></section></main>;
}
